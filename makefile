...
main.exe: $(INCL)/stdafx.h.gch $(INCL)/all.h.gch $(TEST)/all.h.gch $(INCL)/exits.h.gch $(INCL)/limits.h.gch $(INCL)/color.o $(INCL)/colors.o $(INCL)/console.o $(INCL)/join.o $(INCL)/os.o $(INCL)/pause.o $(INCL)/random.o $(INCL)/string.o $(TEST)/etest.o $(TEST)/colors.o $(TEST)/string.o
	$(CC) -g -Wall -std=c++11 -o main.exe main.cpp $(INCL)/color.o $(INCL)/colors.o $(INCL)/console.o $(INCL)/join.o $(INCL)/os.o $(INCL)/pause.o $(INCL)/random.o $(INCL)/string.o $(TEST)/etest.o $(TEST)/colors.o $(TEST)/string.o
...
$(INCL)/limits.h.gch:
	$(CC) $(FLAGS) -o $(INCL)/limits.h.gch $(INCL)/limits.h
